            ...
            <div className="relative flex items-center justify-between h-16">
              ...
              <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex-shrink-0 flex items-center">
                  ...
                  />
                  <img
                    className="hidden lg:block object-fit w-14 pt-5"
                    src={logo}
                    alt="SaveLifeFoundation"
                  />
                </div>
              ...
              <div className="absolute space-x-3 inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                <img
                  ...
                  alt=""
                />
                <a href="https://pmny.in/LIplFS6Lo0ki" className="hidden sm:block inline-flex text-white font-medium bg-yellow-500 border-0 py-1 px-2 focus:outline-none hover:bg-indigo-600 rounded-sm text-xs">Get Started</a>
